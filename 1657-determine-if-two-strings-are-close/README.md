...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/determine-if-two-strings-are-close/)
...
**My Solution:** [1657-Determine-if-Two-Strings-Are-Close.cpp](./1657-Determine-if-Two-Strings-Are-Close.cpp)
